package dev.fujiwara.drawer.forms2;

import dev.fujiwara.drawer.Box;
import dev.fujiwara.drawer.DrawerCompiler;
import dev.fujiwara.drawer.DrawerConsts;
import dev.fujiwara.drawer.PaperSize;
import dev.fujiwara.drawer.form.Form;
import dev.fujiwara.drawer.form.Page;
import dev.fujiwara.drawer.drawerform2.FormCompiler;
import dev.fujiwara.drawer.drawerform2.Hint;
import dev.fujiwara.drawer.drawerform2.Hints;

import java.util.List;

import static dev.fujiwara.drawer.Box.HorizAnchor;
import static dev.fujiwara.drawer.Box.VertAnchor;
